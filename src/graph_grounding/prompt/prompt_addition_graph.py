...
""" Original prompt addition for the graph grounding agent """
...
""" Updated prompt addtion for the graph grounding agent """
...
class Graph(PromptElement):
    ...
    def _prompt(self) -> str:
        ...
        return f"""
The following similar tasks have been solved in the past. Use these paths to guide
your actions.
